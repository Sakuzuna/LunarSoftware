...
mm = r"""
  ...
  sSSs   .S_sSSs      sSSs_sSSs      sSSs  
 d%%SP  .SS~YS%%b    d%%SP~YS%%b    d%%SP  
d%S'    S%S   `S%b  d%S'     `S%b  d%S'    
S%|     S%S    S%S  S%S       S%S  S%|     
S&S     S%S    S&S  S&S       S&S  S&S     
Y&Ss    S&S    S&S  S&S       S&S  Y&Ss    
`S&&S   S&S    S&S  S&S       S&S  `S&&S   
  `S*S  S&S    S&S  S&S       S&S    `S*S  
   l*S  S*S    S*S  S*b       d*S     l*S  
  .S*P  S*S    S*S  S*S.     .S*S    .S*P  
sSS*S   S*S    S*S   SSSbs_sdSSS   sSS*S   
YSS'    S*S    SSS    YSSP~YSSY    YSS'    
        SP                                 
        Y                                  
